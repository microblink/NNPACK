...
#define SQRT2_OVER_2 C99_FLOAT( 0x1.6A09E6p-1f, 0.70710678118f )
#define SQRT2_OVER_4 C99_FLOAT( 0x1.6A09E6p-2f, 0.35355339059f )

#define COS__0PI_OVER_32 1.0f
#define COS__1PI_OVER_32 C99_FLOAT( 0x1.FD88DAp-1f, 0.99518472667f )
#define COS__2PI_OVER_32 C99_FLOAT( 0x1.F6297Cp-1f, 0.9807852804f  )
#define COS__3PI_OVER_32 C99_FLOAT( 0x1.E9F416p-1f, 0.95694033573f )
#define COS__4PI_OVER_32 C99_FLOAT( 0x1.D906BCp-1f, 0.92387953251f )
#define COS__5PI_OVER_32 C99_FLOAT( 0x1.C38B30p-1f, 0.88192126434f )
#define COS__6PI_OVER_32 C99_FLOAT( 0x1.A9B662p-1f, 0.8314696123f  )
#define COS__7PI_OVER_32 C99_FLOAT( 0x1.8BC806p-1f, 0.77301045336f )
#define COS__8PI_OVER_32 SQRT2_OVER_2
#define COS__9PI_OVER_32 C99_FLOAT( 0x1.44CF32p-1f, 0.63439328416f )
#define COS_10PI_OVER_32 C99_FLOAT( 0x1.1C73B4p-1f, 0.55557023302f )
#define COS_11PI_OVER_32 C99_FLOAT( 0x1.E2B5D4p-2f, 0.47139673682f )
#define COS_12PI_OVER_32 C99_FLOAT( 0x1.87DE2Ap-2f, 0.38268343236f )
#define COS_13PI_OVER_32 C99_FLOAT( 0x1.294062p-2f, 0.29028467725f )
#define COS_14PI_OVER_32 C99_FLOAT( 0x1.8F8B84p-3f, 0.19509032201f )
#define COS_15PI_OVER_32 C99_FLOAT( 0x1.917A6Cp-4f, 0.09801714032f )
