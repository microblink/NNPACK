...
static inline void scalar_fft4_aos(
	const float t_lo[C99(restrict static) 4],
	const float t_hi[C99(restrict static) 4],
	size_t stride_t,
...
static inline void scalar_ifft4_aos(
	...
	float t2[C99(restrict static) 4],
	size_t stride_t)
{
	/* Bit reversal */
	scalar_swap(&w1r, &w2r);
...
static inline void scalar_fft8_aos(
	const float t_lo[C99(restrict static) 8],
	const float t_hi[C99(restrict static) 8],
	size_t stride_t,
	uint32_t row_start, uint32_t row_count,
	float f0r[C99(restrict static) 1],
	float f0i[C99(restrict static) 1],
...
static inline void scalar_ifft8_aos(
	...
	float t_lo[C99(restrict static) 8],
	float t_hi[C99(restrict static) 8],
	size_t stride_t)
{
	/* Bit reversal */
	scalar_swap(&w1r, &w4r);
