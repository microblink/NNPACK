...
static inline void scalar_fft8_real(
	const float t0[C99(restrict static) 4],
	const float t4[C99(restrict static) 4],
	size_t stride_t,
	uint32_t row_offset, uint32_t row_count,
	float f[C99(restrict static) 1],
	size_t stride_f)
{
...
static inline void scalar_fft16_real(
	const float t0[C99(restrict static) 8],
	const float t8[C99(restrict static) 8],
	size_t stride_t,
	uint32_t row_offset, uint32_t row_count,
	float f[C99(restrict static) 1],
	size_t stride_f)
...
static inline void scalar_ifft8_real(
	...
	float t0[C99(restrict static) 4],
	float t4[C99(restrict static) 4],
	size_t stride_t)
{
...
static inline void scalar_ifft16_real(
	...
	float t0[C99(restrict static) 8],
	float t8[C99(restrict static) 8],
	size_t stride_t)
{
	/* Load inputs and scale */
	const float scale = 0.5f;
