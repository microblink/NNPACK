...
void nnp_sdotxf1__scalar(
	...
	const float y[C99(restrict static) 1],
	size_t stride_y,
...
void nnp_sdotxf2__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 2],
	size_t stride_y,
...
void nnp_sdotxf3__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 3],
	size_t stride_y,
...
void nnp_sdotxf4__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 4],
	size_t stride_y,
...
void nnp_sdotxf5__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 5],
	size_t stride_y,
...
void nnp_sdotxf6__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 6],
	size_t stride_y,
...
void nnp_sdotxf7__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 7],
	size_t stride_y,
...
void nnp_sdotxf8__scalar(
	const float x[C99(restrict static) 1],
	const float y[C99(restrict static) 8],
	size_t stride_y,
