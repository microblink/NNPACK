...
void nnp_fft4_aos__scalar(
	const float t[C99(restrict static) 8],
	float f[C99(restrict static) 8])
{
...
void nnp_fft8_aos__scalar(
	...
	float f[C99(restrict static) 16])
{
...
void nnp_ifft4_aos__scalar(
	const float f[C99(restrict static) 8],
	float t[C99(restrict static) 8])
{
	const float w0r = f[0];
	const float w0i = f[1];
	const float w1r = f[2];
...
void nnp_ifft8_aos__scalar(
	const float f[C99(restrict static) 16],
